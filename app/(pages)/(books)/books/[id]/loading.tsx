      ...
      <div className="container mx-auto px-4 -mt-32 relative z-10 pb-12">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="shrink-0">
            <div className="w-64 aspect-3/4 bg-muted rounded-lg animate-pulse shadow-2xl" />
          </div>
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <div className="w-22 h-8 bg-muted rounded-full animate-pulse" />
                <div className="w-14 h-8 bg-muted rounded-full animate-pulse" />
                <div className="w-26 h-8 bg-muted rounded-full animate-pulse" />
                <div className="w-19 h-8 bg-muted rounded-full animate-pulse" />
              </div>
            </div>
