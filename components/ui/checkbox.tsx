      ...
      <div className="flex items-center space-x-2">
        <div className="relative">
          <input
            ...
            {...props}
          />
          <div className="absolute inset-0 flex items-center justify-center text-primary opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none">
